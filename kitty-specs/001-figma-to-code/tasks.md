...
## Work Package WP01: Project Setup & Foundation (Priority: P0) 🎯 MVP Foundation
...
## Work Package WP02: TypeScript Types & Contracts (Priority: P0) 🎯 MVP Foundation
...
## Work Package WP03: Figma API Client & Caching (Priority: P1) 🎯 MVP - User Story 1
...
## Work Package WP04: AltNode Transformation Engine (Priority: P1) 🎯 MVP - User Story 1
...
- [ ] T025 [P] Implement normalizeLayout() for auto-layout → flexbox conversion
- [ ] T026 [P] Implement normalizeFills() for Figma fills → CSS background
- [ ] T027 [P] Implement normalizeStrokes() for strokes → CSS border
- [ ] T028 [P] Implement normalizeEffects() for effects → CSS box-shadow
- [ ] T029 [P] Implement normalizeText() for text properties → CSS font properties
...
### Implementation Notes
- Follow transformation rules from research.md (layoutMode HORIZONTAL → display: flex + flexDirection: row)
...
## Work Package WP05: Rule Engine & Conflict Resolution (Priority: P1) 🎯 MVP - User Story 2 & 3
...
- [ ] T039 Benchmark rule matching performance (<10ms for 50 rules × 100 nodes)
...
### Risks & Mitigations
- **Performance with many rules**: Profile with 100 rules × 100 nodes, optimize if >100ms total

---

## Work Package WP06: Code Generators (Priority: P1) 🎯 MVP - User Story 3
...
- React+Tailwind: Map CSS properties to Tailwind classes (e.g., `display: flex` → `className="flex"`)
...
## Work Package WP07: Main UI Layout & Fetch Flow (Priority: P1) 🎯 MVP - User Story 1
...
## Work Package WP09: Live Preview Tabs & Code Display (Priority: P1) 🎯 MVP - User Story 3
...
- [ ] T081 Test rule generality workflow: button variant A → rules → button variant B
...
**Critical Path**: WP01 → WP02 → WP03/WP04 → WP05 → WP06 → WP09 (longest dependency chain)
